...
let HelpTheme = {
  async getThemeCfg (theme, exclude) {
    let dirPath = './plugins/xk/resources/help/theme/'
    let ret = []
    let names = []
    ...
    return {
      ...
      bg: fs.existsSync(`${dirPath}${name}/bg.png`) ? `${resPath}${name}/bg.png` : `${resPath}default/bg.png`,
      style: (await Data.importModule(`resources/help/theme/${name}/config.js`, 'xk')).style || {}
    }
  },
